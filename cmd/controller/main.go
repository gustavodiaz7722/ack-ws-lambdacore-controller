...
import (
	...
	svctypes "github.com/aws-controllers-k8s/lambdacore-controller/apis/v1alpha1"
	svcresource "github.com/aws-controllers-k8s/lambdacore-controller/pkg/resource"

	"github.com/aws-controllers-k8s/lambdacore-controller/pkg/version"
)

var (
	awsServiceAPIGroup = "lambdacore.services.k8s.aws"
	awsServiceAlias    = "lambdacore"
